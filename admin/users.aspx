<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="users.aspx.cs" Inherits="admin_Default" %>
...
<script>
    ...
    $(document).ready(function () {
        dTable = $('#datatab').dataTable({
            ...
            sPlaceHolder: "head:after", aoColumns: [{ type: "text" }, { type: "text" }, { type: "text" }, { type: "text" }, null]
        });
            ...
            <table id="datatab" class="table-bordered table-striped table-condensed cf" style="width:100%">
                ...
                <thead>
                    <tr>
                        ...
                        <th align="center" style="width:10%;">Activate</th>
                        <th class="noExlCol" style="width:10%;">Actions</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td data-title="Country:" align="left">
                                        <%# Eval("Address") %>,<%# Eval("City") %>,<%# Eval("State") %>,<%# Eval("Country") %>
                                    </td>
                                    <td data-title="Country:" align="left">
                                        <%# Eval("Status") %>
                                    </td>
                                    <td align="left">
                                        <button class="btn" title="Go to User Details" type="button" id="button" onclick="location.href='editusers.aspx?id=<%# Eval("Id") %>'"><i class="fa fa-edit"></i></button>

                                        <span class="fa-2x">|</span>

                                        <button class="btn" title="Delete" type="button" id="button" onclick="DeleteUsers('<%# Eval("Id") %>')"><i class="fa fa-trash"></i></button>
                                    </td>
...
<script type="text/javascript">
    function DeleteUsers(ID) {
        if (confirm("Are you sure to delete the record?")) {
            location.href = "users.aspx?id=" + ID;
        }
    }
</script>
